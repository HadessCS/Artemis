...
class Tar(Type):
    ...
    def match(self, buf):
        return len(buf) > 261 and buf[257:262] == b'\x75\x73\x74\x61\x72'
...
class Sqlite(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[:4] == b'\x53\x51\x4c\x69'
...
class Deb(Type):
    ...
    def match(self, buf):
        return len(buf) > 20 and buf[:21] == b'\x21\x3c\x61\x72\x63\x68\x3e\x0a\x64\x65\x62\x69\x61\x6e\x2d\x62\x69\x6e\x61\x72\x79'
...
class Ar(Type):
    ...
    def match(self, buf):
        return len(buf) > 6 and buf[:7] == b'\x21\x3c\x61\x72\x63\x68\x3e'
...
class Z(Type):
    ...
    def match(self, buf):
        return len(buf) > 1 and (buf[:2] == b'\x1f\a0' or buf[:2] == b'\x1f\x9d')
...
class Lzop(Type):
    ...
    def match(self, buf):
        return len(buf) > 7 and buf[:8] == b'\x89\x4c\x5a\x4f\x00\x0d\x0a\1a'
...
class Lz(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[:3] == b'\x4c\x5a\x49\x50'
...
class Elf(Type):
    ...
    def match(self, buf):
        return len(buf) > 52 and buf[:4] == b'\x7f\x45\x4c\46'
...
class Br(Type):
    ...
    def match(self, buf):
        return buf[:4] == b'\xce\xb2\xcf\x81'
...
class Dcm(Type):
    ...
    def match(self, buf):
        return buf[128:131] == b'\x44\x49\x43\x4d'
...
class Rpm(Type):
    ...
    def match(self, buf):
        return buf[:4] == b'\xed\xab\xee\xdb'
